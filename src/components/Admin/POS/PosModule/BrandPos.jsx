...
import { toggleBrand } from "../../../../redux/IchthusSlice";
  ...
  return (
    <div className="w-full">
      <div className="flex items-center justify-start mb-4">
        <h2 className="text-sm font-bold mr-4">Brand</h2>
        <div className="relative w-full">
          ...
          />
          {isSearchActive && filteredBrands.length > 0 && (
              ...
              <ul className="divide-y divide-gray-200">
                {filteredBrands.map((item) => (
                  <li
                    ...
                    onMouseDown={() => handleToggleBrand(item)}
                  >
                    <input
                      type="checkbox"
                      id={item.id}
